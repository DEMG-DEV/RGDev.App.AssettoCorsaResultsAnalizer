...
export const es = {
  ...
  common: {
    ...
    less: 'Menos',
    more: 'Más',
    cachedFiles: '{count} archivos en caché',
    cachedTooltip: 'Las últimas sesiones se guardan automáticamente (máx. 20)',
    clearCache: 'Limpiar caché',
    restoredFromCache: 'Sesiones restauradas del caché',
  },
